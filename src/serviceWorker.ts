...
import appEnv from '@jstoolkit/configs/appEnv';
import buildConfig from '@jstoolkit/configs/buildConfig';
...
const logPrefix = 'SW:';
export const UpdateEventType = 'SW:UPDATE';
        ...
        installingWorker.onstatechange = () => {
          if (installingWorker.state === 'installed') {
            if (navigator.serviceWorker.controller) {
              ...
              window.dispatchEvent(new Event(UpdateEventType));
...
export function unregister(): void {
  if ('serviceWorker' in navigator) {
    void navigator.serviceWorker.ready
      ...
      .catch((error: Error) => {
        console.error(logPrefix, 'Error during service worker unregister:', error.message || error);
      });
  }
}
